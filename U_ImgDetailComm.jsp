...
<head>
<title>User Post comments...</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
       ...
       <h2 class="star" align="left"><span>View Friends Image's Comments </span>.....</h2>
          <p class="star" align="center">&nbsp;</p>
			...
			<div align="left" class="style14 style4 style3" style="	margin-left:20px;">Commented By</div></td>
			<td width="86" height="44" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;">
			<div align="left" class="style14 style4 style3" style="margin-left:20px;">Comment</div></td>
			<td width="86" height="44" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;">
			<div align="left" class="style14 style4 style3" style="margin-left:20px;">Date</div></td>
			</tr>
