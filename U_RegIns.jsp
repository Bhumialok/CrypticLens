      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content">
            <h2 class="style6"><span class="style6">User</span> <span class="style6">Registration</span> <span class="style6">Status</span> </h2>
...
else
{
            ...
            <br />
            <br />
            <p align="center" class="style31 style24"><strong>User Name Already Exist..</strong></p>
            <br />
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,status,image) values(?,?,?,?,?,?,?,?,?)");
            ...
            <br/>
            <p align="center" class="style32 style25 style42"><strong>Registration Successful..</strong></p>
            <br />
