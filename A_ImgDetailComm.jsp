...
<head>
<title>All user Images comment </title>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <div class="post_content">
            <p align="justify">&nbsp;</p>
			<h2><span class="style6">All</span> <span class="style6">Image</span> <span class="style6">Details</span> <span class="style6">Comment</span> ...         </h2>
          ...
          <p><table width="565" border="1.5" align="center"  cellpadding="0" cellspacing="0" >
			...
			<div align="left" class="style3 style4 style14 style7" style="	margin-left:20px;">Commented By</div></td>
			<td width="86" height="44" valign="middle" style="color: #2c83b0;">
			<div align="left" class="style3 style4 style14 style7" style="margin-left:20px;">Comment</div></td>
			<td width="86" height="44" valign="middle" style="color: #2c83b0;">
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
					...
					<%
						...
						try 
						{
							String sql="select * from icomment where imgname='"+iname+"' ";
		...
		<tr>
			  ...
			  <div align="left" class="style6 style10" style="margin-left:20px;"><a href="A_UserProfile.jsp?value=<%=s2%>&type=<%="image"%>"><%=s2%></a></div></td>
...
<%					
			...
			<div align="center">
		          <p>&nbsp;</p>
		          <p><a href="A_ImgDetail.jsp" class="style14">Back</a></p>
            </div>
