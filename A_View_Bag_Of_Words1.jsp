...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      ...
      <div class="gadget">
        <table width="506" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
          <tr>
            
            <td  width="150" height="28" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="center" class="style5 style56 style57"><span class="style6">Bag Of Encrypted Words For </span> <span class="style72">
            <% out.print(request.getParameter("imgname") );%>
</span></div></td>
          ...
          <%
					  ...
					  String imgname=request.getParameter("imgname");
						...
						try 
						{
						   	String query="select * from searchfound where imgname='"+imgname+"'"; 
          ...
          <tr>
            ...
            <td height="54" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style55 style68 style69 style72 style7">
                <%out.println(s3);%>
            </div></td>
